...
\begin{document}
\name{Padhu Ramalingam}
\tagline{Full-stack hands-on architect}
% Cropped to square from https://en.wikipedia.org/wiki/Marissa_Mayer#/media/File:Marissa_Mayer_May_2014_(cropped).jpg, CC-BY 2.0
%\photo{2.5cm}{mmayer-wikipedia-cc-by-2_0}
\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
  \email{apadhu@yahoo.com}
  \phone{904-208-0037}
  \mailaddress{5437 Orchard Lake Drive}
  \location{Jacksonville, FL 32258}\\
%  \homepage{marissamayr.tumblr.com/}
%  \twitter{@marissamayer}
  \linkedin{linkedin.com/in/padhuramalingam}
  \github{github.com/pramalin} % I'm just making this up though.
...
\cvevent{Senior Developer}{Citi Group}{Nov 2016 -- Ongoing}{Jacksonville, FL}
\begin{itemize}
...
\cvevent{Software Engineer}{Mobile Mini}{Nov 2015 -- Nov 2016}{Phoenix, AZ}
\begin{itemize}
...
\cvevent{Senior Developer}{Citizens Property Insurance}{Sep 2014 --  Nov 2015}{Jacksonville, FL}
\begin{itemize}
...
\cvevent{Senior Developer}{Black Knight Financial Services}{Mar 2013 -- Sep 2014}{Jacksonville, FL}
...
\cvevent{Senior Developer}{Sanare LLC}{Feb 2012 -- Feb 2013}{Miramar, FL}
...
\cvevent{Web System Architect}{FSV Payment Systems}{Sep 2007 -- Sep 2011}{Jacksonville, FL}
...
\cvevent{Programmer Analyst}{American Computer Technologies}{Feb 1995 -- July 2007}{Jacksonville, FL}
...
\cvsection[page2sidebar]{Technology Stacks}
\begin{itemize}
